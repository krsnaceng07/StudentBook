      ...
      <View className="px-6 -mt-16">
        <View className="flex-row items-end justify-between mb-4">
          ...
          <TouchableOpacity 
            ...
            className="bg-[#3B82F6] px-6 py-2.5 rounded-xl border border-[#3B82F6]/50 shadow-lg shadow-[#3B82F6]/20"
          >
        ...
        <View className="mb-20">
          <Text className="text-slate-500 font-bold uppercase text-[10px] mb-4 tracking-widest pl-1">Settings</Text>
          
          <TouchableOpacity 
            onPress={logout}
            className="flex-row items-center bg-red-500/10 p-4 rounded-2xl border border-red-500/20"
          >
            <Ionicons name="log-out-outline" size={20} color="#EF4444" />
            <Text className="text-[#EF4444] font-bold ml-3 text-base">Logout</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ScrollView>
